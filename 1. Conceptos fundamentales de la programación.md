...
<?php
function saludar() {
    echo "Hola desde utilidades.php<br>";
}
?>
```
...
- [Guía de programación estructurada (TECNM Apizaco)](https://www.apizaco.tecnm.mx/wp-content/uploads/2023/10/SED2319-Programacion-Estructurada.pdf)
